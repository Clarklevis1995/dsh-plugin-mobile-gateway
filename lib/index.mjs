...
function normalizePublicUrl(value, req, wsPath) {
  ...
  if (url.protocol === 'ws:' && !isLocalHostname(url.hostname)) throw badRequest('publicUrl must use wss:// for non-localhost endpoints')
  return url.toString()
}
      ...
      handler: async (req, res) => {
        try {
          ...
          if (req.method === 'GET' && p === '/mgw/status') {
            ...
            const publicUrl = normalizePublicUrl(body.publicUrl || options.publicUrl, req, wsPath)
