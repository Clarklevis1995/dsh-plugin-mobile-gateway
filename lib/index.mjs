...
/**
 * Whether a host command accepts composer attachments. Alpha1 exposes
 * `input.attachments`; RC1 exposed `input.images`. Accept both so the catalog
 * and the execute validation keep working across host versions.
 */
function commandAcceptsAttachments(command) {
  return command?.input?.attachments === true || command?.input?.images === true
}
